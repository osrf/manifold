...
latex_documents = [
  ('index', 'manifold.tex', u'manifold Documentation',
...
man_pages = [
    ('index', 'manifold', u'manifold Documentation',
...
texinfo_documents = [
  ('index', 'manifold', u'manifold Documentation',
   u'Open Source Robotics Foundation', 'manifold', 'One line description of project.',
   'Miscellaneous'),
]
